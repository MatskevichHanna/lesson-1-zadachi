...
decimal k1 = InputControl("Введите значение k1 что бы задать прямые");
decimal b1 = InputControl($"Введите значение b1 что бы задать прямые");
decimal k2 = InputControl($"Введите значение k2 что бы задать прямые");
decimal b2 = InputControl($"Введите значение b2 что бы задать прямые");
